...
class Task(models.Model):
    project = models.ForeignKey(Project, on_delete=models.Case, default=1)
...
class Notes(models.Model):
    task = models.ForeignKey(Task, on_delete=models.Case, default=1)
    title = models.CharField(max_length=200, default="N/A")
    text = models.CharField(max_length=200)
...
class File(models.Model):
    project = models.ForeignKey(Project, on_delete=models.Case)
